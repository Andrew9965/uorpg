    ...
    <div class="xs-nopadding container-fluid">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('category.store',['city' => session()->get('city_url')])}}" method="post"
        ...
        <div class="row">
            <div class="col-md-8 col-xs-12">
                <h4>@lang('user.category') (1-уровень)</h4>
            </div>
                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        <div class="input-group">
                            <span class="input-group-addon"
                                  style="color: white; background-color: rgb(124,77,255);">Найти категорию (1 уровень)</span>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="posts">
                        @include('admin.pages.categories.category.ajax')
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
        ...
        $(document).ready(function () {
            $("#search").keyup(function () {
                ...
                if (str == "") {
                    ...
                    $.get("{{ route('category.index') }}" + '?search=' + str, function (data) {
                        $(".posts").html(data);
                    });
                }
            });
    ...
    <script>
        ...
        function paginateItem(page) {
            ...
            $.ajax({
                url: '{{route('category.index')}}?page=' + page,
                dataType: 'json',
                data: {
                    'sort_by': sort_by,
                },
        ...
        $(document).on('click', '.success-remove', function (e) {
            ...
            var button = $(this);
            $.ajax({
                url: "/admin/category/" + button.data('id'),
                type: "DELETE",
                data: {
                    _token: "{{csrf_token()}}",
                    id: button.data('id')
