...
return [
    ...
    */
    ...
    'custom' => [
        'password' => [
            'E-mail' => 'Поле должно быть вида x@x.x',
        ],
        'photo_id' => [
            'required' => 'Необходимо хотя бы 1 фото'
        ],
        'rule_accept' => [
            'accepted' => 'Вы должны согласиться с правилами.'
        ]
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'name' => 'Имя',
        'sex' => 'Пол',
        'company' => 'Названия компании',
        'birthday' => 'День рождения',
        'email' => 'Email',
        'keyword' => 'Ключовые слова (keyword)',
        'value' => 'Значение',
        'g-recaptcha-response' => 'Captcha',
        'name_url' => 'URL',
        'legal_form' => 'Организационно-парвовая форма',
        'logo' => 'Логотип',
        'region_id' => 'Регион',
        'lat' => 'Координаты',
        'lng' => 'Координаты',
