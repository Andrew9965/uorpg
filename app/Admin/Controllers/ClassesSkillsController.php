...
use Modules\Classes\Models\ClassesSkills;
...
class ClassesSkillsController extends Controller
{
    use ModelForm;
    ...
    protected function grid()
    {
        ...
        return Admin::grid(ClassesSkills::class, function (Grid $grid) {
    ...
    {
        return Admin::form(ClassesSkills::class, function (Form $form) use ($id) {
            $params = [];

            if($id) $params = ClassesSkills::find($id)->parameters;
            ...
            $form->select('color')->options([
                'fix_cl_bl' => 'Blue Stone',
                'fix_cl_gr' => 'Green House',
                'fix_cl_li' => 'Suva Grey',
            ]);
